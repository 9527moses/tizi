...
如果只用一句话概括这页，它更像一个 `机场推荐主站首页`，不是单纯整理软件下载或堆一堆教程。

我们现在的核心路线很明确：

- 先帮用户判断 `当前该选哪类机场`
- 再告诉用户 `哪些候选更适合新手 / AI / 路由器 / 小流量备用`
- 最后再用教程去解决 `iPhone、Windows、macOS、OpenClash` 这些具体问题

也就是说，这个仓库的主内容不是“教程本身”，而是：
...
所以这页的定位不是给你一长串名字，也不是让你先读一大段教程，而是先帮你快速判断：

- 你属于哪种使用场景
- 你应该先看哪条路线
- 你适不适合直接看某个具体机场

如果你已经有明确需求，可以把这里当成一个入口页：

- 想直接看推荐层，就往下看 `候选表` 和 `场景入口`
- 想解决具体问题，就顺着每个推荐页里的教程入口继续走
- 想确认这个仓库有没有持续维护，就先看 `本周更新` 和 `最近检查候选`

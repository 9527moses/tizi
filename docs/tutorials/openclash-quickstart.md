...
- 导入订阅以后节点或代理组没正常出来：看 [OpenClash 导入订阅失败怎么办](../recommendations/openclash-subscription-import-failed.md)
- 你接的是 Roxi，这条线导入不顺：看 [Roxi OpenClash 导入失败怎么办](../recommendations/roxi-openclash-import-failed.md)
- 单机能用，接路由器后反而不稳：看 [家用翻墙推荐：全家设备场景到底该先看什么](../recommendations/home-cross-border-recommendations.md)
- 想先看哪些路线更适合全屋代理：看 [OpenClash 机场推荐：全屋代理场景先看哪些路线](../recommendations/openclash-airport-recommendations.md)

...
- 连接显示正常，但网页还是打不开：看 [iPhone VPN 已连接但打不开怎么办](../recommendations/iphone-vpn-connected-but-not-working.md)
- Roxi 在 iPhone 上显示已连接但还是不通：看 [Roxi iPhone 已连接但打不开怎么办](../recommendations/roxi-iphone-connected-but-not-working.md)
- 刚开始能用，过一会儿老掉线：看 [翻墙老是掉线怎么办](../recommendations/why-does-vpn-keep-disconnecting.md)
- ChatGPT 首页能开，但登录后一直转圈：看 [ChatGPT 转圈怎么办](../recommendations/chatgpt-loading-forever-fix.md)
